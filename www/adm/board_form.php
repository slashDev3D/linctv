    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <?php } else { ?>
                    <a href="<?php echo get_pretty_url($board['bo_table']) ?>" class="btn_frmline" target="_blank">게시판 바로가기</a>
        ...
        <tr>
		 ...
		 <tr>
            <th scope="row"><label for="bo_10">게시판 대표이미지<strong class="sound_only">필수</strong></label></th>
            <td colspan="2">
        ...
        <tr>
            ...
            <td>
                ...
                <select id="bo_sort_field" name="bo_sort_field">
					...
					<option value="wr_2+0 asc" <?php echo get_selected($board['bo_sort_field'], "wr_2+0 asc"); ?>>wr_2 asc : wr_2 오름차순</option>
					<option value="wr_2+0 desc" <?php echo get_selected($board['bo_sort_field'], "wr_2+0 desc"); ?>>wr_2 desc : wr_2 내림차순</option>
                    <option value="wr_9+0 asc" <?php echo get_selected($board['bo_sort_field'], "wr_9+0 asc"); ?>>wr_9 asc : wr_9 오름차순</option>
					<option value="wr_9+0 desc" <?php echo get_selected($board['bo_sort_field'], "wr_9+0 desc"); ?>>wr_9 desc : wr_9 내림차순</option>
                </select>
            </td>
            <td class="td_grpset">
