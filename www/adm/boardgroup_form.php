...
<form name="fboardgroup" id="fboardgroup" action="./boardgroup_form_update.php" onsubmit="return fboardgroup_check(this);" method="post" enctype="multipart/form-data"autocomplete="off">
...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr style="display:none">
        <th scope="row">그룹이미지</th>
        <td class="td_extra">
	         <input type="file" name="gr_10" title="그룹이미지 첩부 " class="frm_file ">
			 <?=$gr['gr_10'];?>
			 <img src="<?=$gr['gr_10'];?>" border="0" alt="">
        </td>
    </tr>
    <?php for ($i=1;$i<=10;$i++) { ?>
    <tr>
