...
$sql = " select a.*, b.bo_subject, c.gr_subject, c.gr_id not in ('lincArea01','community','lincnews') {$sql_common} {$sql_order} limit {$from_record}, {$rows} ";
...
*/
include_once($new_skin_path.'/new.skin_1.php');
