...
if ($stx) {
    ...
    $srows = isset($_GET['srows']) ? (int)preg_replace('#[^0-9]#', '', $_GET['srows']) : 60;
    if (!$srows) $srows = 60; // 한페이지에 출력하는 검색 행수
	...
	$no_search=array('community','lincArea01','lincArea02','lincArea03','lincArea04','lincArea05','lincevent','lincnews'); //제외할 그룹 지정
...
include_once($search_skin_path.'/search.skin_tv.php');
