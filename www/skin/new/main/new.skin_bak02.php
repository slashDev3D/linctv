...
<div class="swiper-container swiper-container-slide newgroup">
<div class="swiper-wrapper">

	 <div class="swiper-slide swiper-slide-slide sideslide">
...
<div class="lincprev-new"><i class="xi-angle-left"></i></div>
<div class="lincnext-new"><i class="xi-angle-right"></i></div>
</div>
...
<script>
    var mySwiper = new Swiper('.newgroup', {
...
/*
mySwiper.appendSlide.eq(1) ([
      '<div class="swiper-slide">Slide 10"</div>', 
      '<div class="swiper-slide">Slide 11"</div>'
]);

mySwiper.addSlide(2, [
 '<div id="center01" class="swiper-slide"></div>'
]);

mySwiper.addSlide(7, [
 '<div id="center02" class="swiper-slide"></div>'
]);
*/
</script>