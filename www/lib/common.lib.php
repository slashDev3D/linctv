...
function get_paging($write_pages, $cur_page, $total_page, $url, $add="")
{
    ...
    $str = '';
    if ($cur_page > 1) {
        $str .= '<a href="'.$url.'1'.$add.'" class="pg_page pg_start"><i class="xi-backward"></i></a>'.PHP_EOL;
    }
    ...
    if ($start_page > 1) $str .= '<a href="'.$url.($start_page-1).$add.'" class="pg_page pg_prev"><i class="xi-angle-left-min"></i></a>'.PHP_EOL;
    ...
    if ($total_page > $end_page) $str .= '<a href="'.$url.($end_page+1).$add.'" class="pg_page pg_next"><i class="xi-angle-right-min"></i></a>'.PHP_EOL;

    if ($cur_page < $total_page) {
        $str .= '<a href="'.$url.$total_page.$add.'" class="pg_page pg_end"><i class="xi-forward"></i></a>'.PHP_EOL;
    }
...
function get_group_list($gr_id, $is_cache=false)
{
    global $g5;
    ...
    $group = run_replace('get_group_list', sql_fetch($sql), $gr_id, $is_cache);
