...
switch($bo_table){
    case $bo_table : $img = $board['bo_subject'];  break;
...
switch($c_file){
    case "group_univercity.php" : $img = "LINC+산학협력 고도화형" ;  break;    
}
?>
		...
		<div class="contain_inner">
			...
			<h2>
				<?php if ($gr_id == "lincArea01" || $gr_id == "lincArea02" || $gr_id == "lincArea03" || $gr_id == "lincArea04" || $gr_id == "lincArea05") { ?>
					LINC+산학협력 고도화형
				<?php } else { ?>
					<?php echo($lMenu['pTitle']?$lMenu['pTitle']:$lMenu['gTitle']);?>
				<?php } ?>
			</h2>
					...
					<div class="location">
						<ul class="Fclear">
							...
							<?php if ($gr_id == "lincArea01" || $gr_id == "lincArea02" || $gr_id == "lincArea03" || $gr_id == "lincArea04" || $gr_id == "lincArea05") { ?>
							<li style="border-right:1px solid #003E83"><a href="<?php echo($lMenu['gLink']);?>">LINC+산학협력 고도화형</a></li>
							<?php } ?>
