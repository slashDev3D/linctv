...
$(document).ready(function(){
	...
	setInterval(function(){
	 ...
	 global_roll_issue_top = global_roll_issue_top - 238;
	 if(global_roll_issue_top < -480) global_roll_issue_top = 0;
	 var o_code = '01';
	 if(global_roll_issue_top == 0) o_code = '01';
	 if(global_roll_issue_top == -238) o_code = '02';
	 if(global_roll_issue_top == -476) o_code = '03';
...
function roll_issue_change(o_this,object){
 ...
 $(".roll_resizeimg").css('min-height','238');
...
?>
      <div class="roll_issue_left_img roll_issue_img0<?php echo $num;?>" style="background:url('/data/file/<?php echo $list[$i]['bo_table']?>/<?php echo $image?>')no-repeat center center;background-size:cover">
