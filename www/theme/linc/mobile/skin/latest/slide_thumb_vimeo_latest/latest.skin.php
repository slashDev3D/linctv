...
<div class="swiper-container swiper-container-slide" style="padding-bottom:50px;">
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide swiper-slide-slide">
            <div class="slide_img" id="vimeo_latest_end-<?php echo $list[$i]['wr_10'] ?>" style="height:132px;" onclick="location.href='<?php echo $list[$i]['href'] ?>';">
			<img id="vimeo_latest_end-<?php echo $list[$i]['wr_10'] ?>" style="display:none"/>
			<script>
				$(function() {
					vimeoLoadingThumb_latest_end("<?php echo $list[$i]['wr_10'] ?>");
				});
			</script>
...
<script>
		function vimeoLoadingThumb_latest_end(id){    
			var url = "http://vimeo.com/api/v2/video/" + id + ".json?callback=showThumb_latest_end";
			var id_img = "#vimeo_latest_end-" + id;
		...
		function showThumb_latest_end(data){
			var id_img = "#vimeo_latest_end-" + data[0].id;
