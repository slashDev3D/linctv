...
?>
      ...
      <div class="roll_issue_left_img roll_issue_img0<?php echo $num;?>" style="background:url('/data/file/<?php echo $list[$i]['bo_table']?>/<?php echo $image?>')no-repeat center top">
	   <?php if($is_admin) {?><div style="display:inline-block;background-color:#333;color:#fff;padding:3px"><a href="/bbs/write.php?w=u&bo_table=schedule&wr_id=<?php echo $list[$i]['wr_id'];?>" target="_blank" style="color:#fff">수정</a></div><? } ?>	
