...
<div id="bo_gallery">
    ...
    <ul id="news_ul">
        ...
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>">
            <a href="<?php echo $list[$i]['href'] ?>" class="<?php if ($bo_table == "news") { ?>gall_img_short<?php } else { ?>gall_img<?php } ?>">
            ...
            <div class="gall_txt">
                ...
                <div class="lt_detail ellipsis"><?=cut_str(str_replace("&nbsp;", "", trim(strip_tags($list[$i]['wr_content']))), 100)?></div>
				<?php if ($bo_table == "event" || $bo_table == "event_1") {?>
				<div class="lt_infos">
				 <?php if ($list[$i]['wr_1']) {?>
					<dd class="ellipsis01"><i class="xi-checkbox-blank"></i> 기간 : <font class="eng"><?php echo $list[$i]['wr_1'] ?></font></dd>
				 <?php } ?>
				 <?php if ($list[$i]['wr_3']) {?>
					<dd class="ellipsis01"><i class="xi-checkbox-blank"></i> 장소 : <?php echo $list[$i]['wr_3'] ?></dd>
				 <?php } ?>
				</div>
				<?php } ?>

				<div class="lt_date eng"><?php //echo date("Y.m.d", strtotime($list[$i]['wr_datetime'])) ?></div>
            </div>
        </li>
        <?php } ?>
