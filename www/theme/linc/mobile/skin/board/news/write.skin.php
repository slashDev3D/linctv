...
<section id="bo_w">
    ...
    <div class="form_01 write_div">
		...
		<div class="write_div">
            <label for="wr_1" class="sound_only">기간1</label>
            <input type="text" name="wr_1" value="<?php echo $write['wr_1']; ?>" id="wr_1" class="frm_input full_input" placeholder="기간1">
        </div>

		<div class="write_div">
            <label for="wr_2" class="sound_only">기간2</label>
            <input type="text" name="wr_2" value="<?php echo $write['wr_2']; ?>" id="wr_2" class="frm_input full_input" placeholder="<?php if($bo_table === 'event') { ?>정렬기준-시작기간 ex)20210708<? }else{ ?>기간2<? } ?>">
        </div>

		<div class="write_div">
            <label for="wr_3" class="sound_only">장소</label>
            <input type="text" name="wr_3" value="<?php echo $write['wr_3']; ?>" id="wr_3" class="frm_input full_input" placeholder="장소">
        </div>

		<div class="write_div">
            <label for="wr_4" class="sound_only">대상</label>
            <input type="text" name="wr_4" value="<?php echo $write['wr_4']; ?>" id="wr_4" class="frm_input full_input" placeholder="대상">
        </div>

		<div class="write_div">
            <label for="wr_5" class="sound_only">참여방법</label>
            <input type="text" name="wr_5" value="<?php echo $write['wr_5']; ?>" id="wr_5" class="frm_input full_input" placeholder="참여방법">
        </div>

		<div class="write_div">
            <label for="wr_6" class="sound_only">주요내용</label>
			<textarea name="wr_6" id="wr_6" class="frm_input full_input" style="height:80px"><?php echo $write['wr_6'] ?></textarea>
		...
		<div class="write_div">
            <label for="wr_7" class="sound_only">혜택</label>
            <input type="text" name="wr_7" value="<?php echo $write['wr_7']; ?>" id="wr_7" class="frm_input full_input" placeholder="혜택">
        </div>

		<div class="write_div">
            <label for="wr_8" class="sound_only">문의처</label>
            <input type="text" name="wr_8" value="<?php echo $write['wr_8']; ?>" id="wr_8" class="frm_input full_input" placeholder="문의처">
        </div>
