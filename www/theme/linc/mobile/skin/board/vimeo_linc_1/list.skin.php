...
<?  
sql_query(" update g5_write_university02_test set wr_hit = wr_hit + 1 where wr_id = '{$list[$i][wr_id]}' ");
...
<div class="linc_wrap">
		...
		<style>
		#bo_sch {float:left;border:1px solid #ddd;background-color:#f9f9f9;border-radius:5px}
		#bo_sch:after {display:block;visibility:hidden;clear:both;content:""}
		#bo_sch legend {position:absolute;margin:0;padding:0;font-size:0;line-height:0;text-indent:-9999em;overflow:hidden}
		#bo_sch select{border:0;margin:9px 5px ;height:20px;float:left;border-right:1px solid #ddd;}
		#bo_sch .sch_input{height:38px;border:0;padding:0 10px;background-color:transparent;float:left;}
                ...
                <div class="swiper-wrapper swiper-wrapper-ga">
                    <table>
                        ...
                        <div class="swiper-slide swiper-slide-ga">
							...
							<style>
							.clipBtn {position:absolute;top:-5px;right:0px;border:0px solid #ccc;color:#666;display:inline-block;padding:0px 0px;font-size:9px;line-height:20px;border-radius:25px;cursor:pointer}
							.clipBtn i {font-size:15px;vertical-align:middle;margin-top:-3px}
							</style>
							
                            <ul>
                                <li class="main_lists_tit cut">
                                    <a data-video="<?php echo $list[$i]['wr_10']; ?>" class="popyt mov_b2 titles_list">
                                        <?php echo $list[$i]['wr_subject'] ?> / <?php echo $list[$i]['wr_hit'] ?>
                                    </a>
									<?php //include(G5_SNS_PATH."/view.sns.skin.php?wr_id=".$list[$i]['wr_id']);?>
                                ...
                                <li class="main_lists_date eng">
									...
									<span class="clipBtn eng" onclick="copyToClipboard('#p1_<?php echo $list[$i]['wr_10'] ?>')"><i class="xi-share-alt-o"></i> COPY</span>
