        ...
        <ul class="bbs_write_div_l">
            <div>
                <ul>
                    ...
                    <li class="divmb-10">
                        <input type="text" name="wr_10" value="<?php echo $write['wr_10']; ?>" id="wr_10" class="bbs_w_inp w100 video_inp" placeholder="비메오 동영상 ID">
                        <dd class="help_txts">
                            비메오 동영상의 ID를 입력하시면 동영상이 출력 되며, 썸네일이 자동등록 됩니다.<br>
                            https://vimeo.com/<b>ID</b>
                        </dd>
                    </li>
