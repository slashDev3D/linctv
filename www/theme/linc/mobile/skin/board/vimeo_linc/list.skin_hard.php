...
//include_once($board_skin_path.'/vimeo.lib.php');
...
<div class="linc_wrap">
        ...
        <form name="fboardlist" id="fboardlist" action="<?php echo G5_BBS_URL; ?>/board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
                ...
                <div class="swiper-wrapper swiper-wrapper-ga">
                    <table>
                        ...
                        for ($i=0; $i<count($list); $i++) {
							...
							//$vimeo_thumbnail = grab_vimeo_thumbnail('https://player.vimeo.com/video/286720840'); 
							//$vimeo_thumbnail = grab_vimeo_thumbnail('https://player.vimeo.com/video/'.$list[$i]['wr_10']);
							//echo $vimeo_thumbnail."111";
                        ...
                        <div class="swiper-slide swiper-slide-ga">
                            <!--<ul class="img_link" /*style="height:<?php echo $board['bo_gallery_height']; ?>px; background-image:url('<?php echo $img_content ?>');" onclick="location.href='<?php echo $list[$i]['href'] ?>';">
							 <ul class="img_link" id="vimeo-<?php echo $list[$i]['wr_10'] ?>" onclick="location.href='<?php echo $list[$i]['href'] ?>';" style="height:<?php echo $board['bo_gallery_height']; ?>px;">-->
							 <ul class="popyt mov_b2 img_link" id="vimeo-<?php echo $list[$i]['wr_10'] ?>" data-video="<?php echo $list[$i]['wr_10']; ?>" style="height:<?php echo $board['bo_gallery_height']; ?>px;">
		   ...
		   <!-- // <div class="divs">
        <a data-video="<?php echo $list[$i]['wr_1']; ?>" class="popyt mov_b2" style="cursor:pointer;">
            <img src="mov_on.png">
        </a>
    </div>
    테스트 버튼 -->
