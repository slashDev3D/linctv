...
#contents {max-width:100%;margin:0px auto;overflow:hidden;}
}
</style>
   ...
   <?php if ($view['wr_10']) { ?>
	...
	<?php } ?>
		...
		<div id="collapse" class="main_lists_date v_top_hd">
			...
			<div class="left_div">
				<div class="imgThumb" style="background:url('https://img.youtube.com/vi/<?php echo $view['wr_10']?>/0.jpg');background-position:center center;background-size:cover;">
				</div>
			</div>
			<div class="right_div">
		...
		<div class="moreinfo_open"><span>간략히</span> <i class="xi-angle-down-min"></i></div>
    ...
    $('.moreinfo_open').click(function(){
        ...
        $('.v_top_hd').slideToggle('slow', function() {
            if ($(this).is(":visible")) {
				 ...
				 link.find('i').removeClass('xi-angle-down-min').addClass( 'xi-angle-up-min' );	               
            } else {
                
				 link.find('i').removeClass('xi-angle-up-min').addClass( 'xi-angle-down-min' );	 
            }        
        });
