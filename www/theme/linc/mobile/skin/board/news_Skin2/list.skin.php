...
<div id="bo_gallery">
    ...
    <ul id="news_ul">
        ...
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>">
                ...
                <div class="inner">
                    <!-- <div class="gbox gcate">
                        <a href="<?php echo $list[$i]['ca_name_href'] ?>" class=""><?php echo $list[$i]['ca_name'] ?></a>
                    </div> -->

                    <div class="gbox gtxt">
                        <a href="<?php echo $list[$i]['href'] ?>" class="">
                            <?php if($list[$i]['ca_name']) { ?><div class="a">#<?php echo $list[$i]['ca_name'] ?></div><?php } ?>
                            <div class="t"><?php echo $list[$i]['subject'] ?></div>
                            <div class="c"><?=cut_str(str_replace("&nbsp;", "", trim(strip_tags($list[$i]['wr_content']))), 100)?></div>
                            <div class="s">출처 : <?php echo $list[$i]['wr_3'] ?></div>
                        </a>
                    </div>

                    <div class="gbox gimg" style="background-image:url(<?php echo $thumb['ori']?>)"></div>
                </div>
        </li>
        <?php } ?>
