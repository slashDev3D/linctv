...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_atc" style="<?php if($bo_table == "linc_event"){?>text-align:center<? } ?>">
        ...
        if($v_img_count) {
         ...
         ?>
		   ...
		   <header>
        <h1 id="bo_v_title" style="<?php if($bo_table == "linc_event"){?>font-size:2em;<? } ?>">
            <?php
    ...
    <section id="bo_v_info">
        <h2>페이지 정보</h2>
		<p class="period">기간 : <span class="eng"><?php echo $write['wr_1']." ~ ".$write['wr_2']; ?></span></p>
         ...
         ?>
            <li>
                <a href="<?php echo $view['link_href'][$i] ?>" target="_blank">
                    <b>링크 바로가기</b><span class="bar"></span>
                    <?php echo $link ?>
