...
<!-- 댓글 리스트 -->
<section id="bo_vc">
    <h2 class="bo_vc_tit eng">COMMENTS <span><?php echo $view['wr_comment']; ?></span></h2>
    <?php
    for ($i=0; $i<count($list); $i++) {
        ...
        $str = $mention_user.$list[$i]['content'];
		...
		$moaboza_wr_name = $list[$i]['wr_name'];
    ?>
    <article id="c_<?php echo $comment_id ?>">
        <div class="comment_inner">
            <header>
                ...
                <span class="bo_vc_hdinfo eng"><i class="fa fa-clock-o" aria-hidden="true"></i> <time datetime="<?php echo date('Y-m-d\TH:i:s+09:00', strtotime($list[$i]['datetime'])) ?>"><?php echo $list[$i]['datetime'] ?></time></span>
                <?php
                ...
                <div class="bo_vl_opt">
                    ...
                    <ul class="bo_vc_act">
                        <?php if ($list[$i]['is_reply']) { ?><li><a href="<?php echo $c_reply_href; ?>" onclick="comment_box('<?php echo $comment_id ?>', '<?php echo get_text($moaboza_wr_name)?>', 'c'); return false;"><i class="fa fa-commenting-o" aria-hidden="true"></i></a></li><?php } ?>
                        <?php if ($list[$i]['is_edit']) { ?><li><a href="<?php echo $c_edit_href; ?>" onclick="comment_box('<?php echo $comment_id ?>', '<?php echo get_text($moaboza_wr_name)?>', 'cu'); return false;"><i class="fa fa-pencil" aria-hidden="true"></i></a></li><?php } ?>
                        <?php if ($list[$i]['is_del']) { ?><li><a href="<?php echo $list[$i]['del_link']; ?>" onclick="return comment_delete();"><i class="fa fa-trash-o" aria-hidden="true"></i></a></li><?php } ?>
                    </ul>
                </div>
                <?php } ?>
...
<?php if ($is_comment_write) {
    ...
    <aside id="bo_vc_w">
		...
		<input type="hidden" name="mention_user" value="moaboza" id="mention_user">
        ...
        <div class="bo_vc_w_wr">
            <div class="bo_vc_w_info">
				...
				<div class="guest_div" style="float:right;margin-right:0px">	
