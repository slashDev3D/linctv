	         ...
	         ?>
	            <li>
	            	<div class="sch_res_title">
	                    <a href="<?php echo $list[$idx][$i]['href'] ?><?php echo $comment_href ?>" class="sch_res_tit"><?php echo $comment_def ?><?php echo $list[$idx][$i]['subject'] ?></a>
	                    <a href="<?php echo $list[$idx][$i]['href'] ?>" target="_blank" class="sch_res_new">새창</a>
	                </div>
	                <p><?php echo $iimg?><?php echo $list[$idx][$i]['content'] ?></p>
