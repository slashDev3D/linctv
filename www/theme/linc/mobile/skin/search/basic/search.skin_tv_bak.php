	        ...
	        for ($i=0; $i<count($list[$idx]) && $k<$rows; $i++, $k++) {
	         ...
	         ?>
	            <li>
					 ...
					 <ul class="img_link" style="background-image:url('<?php echo $img_content ?>');background-size:cover;background-position:center center" onclick="location.href='<?php echo $list[$i]['href'] ?>';">
