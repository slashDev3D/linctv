...
include_once(G5_LIB_PATH.'/all.lib.php');
...
<div id="tnb_main">
    	<div class="inner">
			<ul id="hd_qnb_left"><?php echo visit('Countup.basic');?></ul>
			<ul id="hd_qnb">
        ...
        <ul>
			 <li><a href="/lincInc/lincIntro.php">링크+TV</a>
				<ul>
					...
					<li><a href="/lincInc/linc_contents.php">링크+ TV 콘텐츠</a></li>
				</ul>        
            </li>
            ...
            ?>
                <li class="gnb_1dli">
                   ...
                   <?php
                    ...
                    ?>
                        <li><a href="<?php echo $row2['me_link']; ?>" target="_<?php echo $row2['me_target']; ?>" class="gnb_2da"><span></span><?php echo $row2['me_name'] ?></a></li>
                    <?php
					$k++;
                    }	//end foreach $row2
                ...
                <li class="menu_li">
                   ...
                   <!-- <?php
					...
					<?php if( $row['me_name'] == "링크+TV") {?>
						...
						<ul class="sub_menu">
							<li class="sb_menu_li"><a href="/lincInc/lincIntro.php" class="sb_menu_a"><span></span>링크+ TV소개</a></li>
							<li class="sb_menu_li"><a href="/lincInc/linc_contents.php" class="sb_menu_a"><span></span>링크+ 진행콘텐츠</a></li>
						</ul>
					<? } else if( $row['me_name'] == "뉴스 모아보기") { ?>
						<button type="button" class="btn_menu_op"><span class="sound_only">하위분류</span><i class="xi-angle-down-min"></i></button>
						<ul class="sub_menu">
...
<? } ?>
	...
	<div id="container_title" class="top" title="<?php echo get_text($g5['title']); ?>">
		<div class="contain_inner_sch">
				<h2>"<?php echo $stx ?>"으로 검색한 결과입니다.</h2>
		</div>
	</div>
			...
			<div class="contain_inner">
				<h2><?php echo $hTitle ?></h2>
					...
					<div class="navpage">	
						<div class="location">
							<ul class="Fclear">
								<li class="home"><a href="<?php echo(G5_URL);?>" class="home"><i class="xi-home-o"></i></a></li>

								<?php if ($gr_id == "lincArea01" || $gr_id == "lincArea02" || $gr_id == "lincArea03" || $gr_id == "lincArea04" || $gr_id == "lincArea05") { ?>
									<li style="border-right:1px solid #003E83"><a href="<?php echo($lMenu['gLink']);?>">LINC+사업단 바로가기</a></li>
								<?php } else if ($c_file == "lincIntro.php") { ?>
									<li style="border-right:1px solid #003E83"><a href="<?php echo($lMenu['gLink']);?>">링크+ TV 소개</a></li>
								<?php } ?>

								<li><a href="<?php echo($lMenu['gLink']);?>"><?php echo($lMenu['gTitle']);?></a></li>

								<?php if($lMenu['pTitle']) { ?>
								<li style="border-left:1px solid #003E83"><?php echo($lMenu['pTitle']);?></li>
								<?php } ?>
							</ul>
						</div>
					</div>
	...
	<div id="contents_main" style="max-width:100%;margin-top:0px">
	<?php } else { ?>
